namespace SolarixGrammarEngineNET
{
 ...
 {
  public const string VERSION_MARK="This file is generated 26.07.2015 13:56:40 by Ygres compiler ver. 14.01.11156 Standard Win32  (build date Jul 20 2015).";
// Languages
...
// Coordiname РазмерСила states:
 ...
 public const int PERSON_ru = 11;                  // enum ЛИЦО
...
// Coordiname РОД states:
 ...
 public const int TRANSITIVENESS_ru = 14;          // enum ПЕРЕХОДНОСТЬ
// Coordiname ПЕРЕХОДНОСТЬ states:
 ...
 public const int PARTICIPLE_ru = 15;              // enum ПРИЧАСТИЕ

 public const int PASSIVE_PARTICIPLE_ru = 16;      // enum СТРАД

 public const int ASPECT_ru = 17;                  // enum ВИД
// Coordiname ВИД states:
 public const int PERFECT_ru = 0;                  // ВИД : СОВЕРШ
 public const int IMPERFECT_ru = 1;                // ВИД : НЕСОВЕРШ

 public const int VERB_FORM_ru = 19;               // enum НАКЛОНЕНИЕ
// Coordiname НАКЛОНЕНИЕ states:
 public const int VB_INF_ru = 0;                   // НАКЛОНЕНИЕ : ИЗЪЯВ
 public const int VB_ORDER_ru = 1;                 // НАКЛОНЕНИЕ : ПОБУД

 public const int TENSE_ru = 20;                   // enum ВРЕМЯ
// Coordiname ВРЕМЯ states:
 ...
 public const int SHORTNESS_ru = 21;               // enum КРАТКИЙ

 public const int CASE_ru = 23;                    // enum ПАДЕЖ
...
// Coordiname ПЕРЕЧИСЛИМОСТЬ states:
 ...
 public const int COMPAR_FORM_ru = 26;             // enum СТЕПЕНЬ
// Coordiname СТЕПЕНЬ states:
 ...
 public const int CASE_GERUND_ru = 27;             // enum ПадежВал
// Coordiname ПадежВал states:

 public const int MODAL_ru = 28;                   // enum МОДАЛЬНЫЙ

 public const int VERBMODE_TENSE = 29;             // enum СГД_Время
// Coordiname СГД_Время states:

 public const int VERBMODE_DIRECTION = 30;         // enum СГД_Направление
// Coordiname СГД_Направление states:

 public const int NUMERAL_CATEGORY = 31;           // enum КАТЕГОРИЯ_ЧИСЛ
// Coordiname КАТЕГОРИЯ_ЧИСЛ states:
 ...
 public const int ADV_SEMANTICS = 32;              // enum ОБСТ_ВАЛ
// Coordiname ОБСТ_ВАЛ states:
 ...
 public const int ADJ_TYPE = 33;                   // enum ТИП_ПРИЛ
// Coordiname ТИП_ПРИЛ states:
 ...
 public const int PRONOUN_TYPE_ru = 35;            // enum ТИП_МЕСТОИМЕНИЯ
...
// Coordiname ТИП_ЧАСТИЦЫ states:
 ...
 public const int ADV_MODIF_TYPE = 37;             // enum ТИП_МОДИФ
// Coordiname ТИП_МОДИФ states:

 public const int TENSE_en = 44;                   // enum TENSE
// Coordiname TENSE states:
 ...
 public const int DURATION_en = 45;                // enum DURATION
...
// Coordiname CASE states:
 ...
 public const int NOUN_FORM_en = 48;               // enum NOUN_FORM
// Coordiname NOUN_FORM states:
 ...
 public const int PRONOUN_FORM_en = 49;            // enum PRONOUN_FORM
// Coordiname PRONOUN_FORM states:

 public const int ADJ_FORM_en = 50;                // enum ADJ_FORM
// Coordiname ADJ_FORM states:
 ...
 public const int COMPARABILITY_en = 51;           // enum COMPARABILITY
// Coordiname COMPARABILITY states:
 ...
 public const int VERB_FORM_en = 52;               // enum VERB_FORM
// Coordiname VERB_FORM states:
 ...
 public const int ARTICLE_FORM = 53;               // enum ARTICLE_FORM
// Coordiname ARTICLE_FORM states:
 ...
 public const int ENG_MODALITY = 54;               // enum ENG_MODALITY
// Coordiname ENG_MODALITY states:
 ...
 public const int NUMERAL_FORM_en = 55;            // enum NUMERAL_FORM
// Coordiname NUMERAL_FORM states:
 ...
 public const int GENDER_en = 56;                  // enum ENG_GENDER
// Coordiname ENG_GENDER states:
 ...
 public const int TRANSITIVITY_en = 57;            // enum TRANSITIVITY
// Coordiname TRANSITIVITY states:
 ...
 public const int OBLIG_TRANSITIVITY_en = 58;      // enum OBLIG_TRANSITIVITY

 public const int PROPER_NOUN_en = 59;             // enum ENG_PROPER_NOUN

 public const int MASS_NOUN_en = 60;               // enum ENG_MASS_NOUN

 public const int PERSON_fr = 61;                  // enum FR_PERSON
// Coordiname FR_PERSON states:
 ...
 public const int NUMBER_fr = 62;                  // enum FR_NOMBRE
// Coordiname FR_NOMBRE states:
 ...
 public const int GENDER_fr = 63;                  // enum FR_GENRE
// Coordiname FR_GENRE states:
 ...
 public const int FR_NUMERAL_FORM = 64;            // enum FR_NUMERAL_FORM
// Coordiname FR_NUMERAL_FORM states:
 ...
 public const int FR_PRONOUN_FORM = 65;            // enum FR_PRONOUN_FORM
// Coordiname FR_PRONOUN_FORM states:
 ...
 public const int TRANSITIVITY_fr = 66;            // enum FR_TRANSITIVITY
// Coordiname FR_TRANSITIVITY states:
 ...
 public const int VERB_FORM_fr = 67;               // enum FR_VERB_FORM
// Coordiname FR_VERB_FORM states:
 ...
 public const int JAP_FORM = 68;                   // enum JAP_FORM
// Coordiname JAP_FORM states:
 ...
 public const int JAP_VERB_BASE = 69;              // enum JAP_VERB_BASE
// Coordiname JAP_VERB_BASE states:
 ...
 public const int JAP_VERB_KIND = 70;              // enum JAP_VERB_KIND
// Coordiname JAP_VERB_KIND states:
 ...
 public const int JAP_ADJ_BASE = 71;               // enum JAP_ADJ_BASE
// Coordiname JAP_ADJ_BASE states:
 ...
 public const int JAP_ADJ_FORM2 = 72;              // enum JAP_ADJ_FORM2
// Coordiname JAP_ADJ_FORM2 states:
 ...
 public const int JAP_TRANSITIVE = 73;             // enum JAP_TRANSITIVE

 public const int CASE_jap = 74;                   // enum JAP_CASE
// Coordiname JAP_CASE states:
 ...
 public const int GENDER_jap = 75;                 // enum JAP_GENDER
// Coordiname JAP_GENDER states:
 ...
 public const int PERSON_jap = 76;                 // enum JAP_PERSON
// Coordiname JAP_PERSON states:
 ...
 public const int NUMBER_jap = 77;                 // enum JAP_NUMBER
// Coordiname JAP_NUMBER states:
 ...
 public const int JAP_PRONOUN_TYPE = 78;           // enum JAP_PRONOUN_TYPE
